...
| `algorithm` | `single_island`, `multi_island`, `single_island_fitness_prop_fixed_temp`, `single_island_weighted` |
| `llm` | `single`, `heterogeneous`, `heterogeneous_bandit`, `openrouter_bandit`, `openrouter_ensemble`, `google`, `openai` |
| `pipeline` | `standard`, `with_context`, `auto`, `custom`, `hotpotqa_asi`, `prompt_evolution`, `optuna_opt`, `cma_opt` |
