"""Validate neurips_test/aime chain and compute accuracy fitness on math olympiad problems."""
...
from problems.chains.neurips_test.aime.shared_config import (
    LLM_CONFIG,
    load_context,
    outer_context_builder,
)
from problems.chains.neurips_test.aime.static.config import FULL_CHAIN_CONFIG
