...
PROBLEM_DIR = ROOT / "problems" / "algotune_lqr"
...
def test_problem_context_is_valid() -> None:
    ...
    assert "linear-quadratic regulator" in pc.task_description.lower()
...
def test_baseline_solves_fixed_suite() -> None:
    ...
    assert metrics["avg_relative_cost_error"] == pytest.approx(0.0, abs=1.0e-12)
